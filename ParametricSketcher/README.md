...
ctest now registers **23 suites** — 15 per-phase or per-feature verification binaries (850 checks total) and 12
script smoke tests — and all 23 run green on every commit. The per-suite check counts:
