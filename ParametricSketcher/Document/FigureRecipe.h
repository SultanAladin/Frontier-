//============================================================================================================================================
// 📦 ParametricSketcher/Document/FigureRecipe.h — How a derived figure was made, so it can be made again when its sources move
//============================================================================================================================================
...
enum class RecipeOperation : uint8_t { None = 0, Extrude, Revolve, Loft, Sweep, Pipe, Patch };
...
struct FigureRecipe
{
    ...
    [[nodiscard]] Deliver<Product> Produce(const SceneDocument& Scene, const Workplane& Work) const noexcept;
