...
arbitrary trimmed/free-form surfaces, branching chains, thin-wall interactions, arbitrary holes, oblique bores, unsupported multiple stepped-cavity sets, more-than-eight through-holes, unequal/non-orthogonal or two-edge corner patches, and
