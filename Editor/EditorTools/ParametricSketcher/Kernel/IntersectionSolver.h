...
//    General free-form intersections must be transversal. Exact duplicate B-reps and contact cases for two axis-aligned
...
public:
    ...
    // A ∪ B, A − B, A ∩ B of two closed solids. Exact duplicate B-reps and axis-aligned boxes resolve their
