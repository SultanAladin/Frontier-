...
public:
    ...
    // preserving up to eight separated axis-parallel through-holes/blind cavities, one coaxial stepped cavity with up
    // to eight decreasing diameters, or exactly two separated two-stage cavities. Other bounded sets refuse.
