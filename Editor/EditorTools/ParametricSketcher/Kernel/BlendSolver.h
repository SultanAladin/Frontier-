...
public:
    ...
    // preserving a bounded set of up to eight separated axis-parallel circular through-holes inside the exact inward-
    // offset rounded wall; all twelve rebuild the complete unperforated network. Other shared-vertex sets refuse.
