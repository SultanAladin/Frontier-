...
public:
    ...
    // preserving one or two separated axis-parallel circular through-holes inside the exact inward-offset rounded wall;
    // all twelve rebuild the complete unperforated rounded network. Other shared-vertex sets refuse before construction.
