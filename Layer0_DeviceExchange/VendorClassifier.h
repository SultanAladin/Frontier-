//============================================================================================================================================
// 📦 Frontier/Layer0_DeviceExchange/VendorClassifier.h — Hardware Capability Classification and Feature Profiling
//============================================================================================================================================
...
private:
    VendorCapabilities      m_Capabilities;                     // [struct] cached hardware capabilities
};
...
{
    return m_Capabilities.Category;
}
