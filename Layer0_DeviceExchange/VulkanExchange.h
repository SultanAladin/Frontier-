//============================================================================================================================================
// 📦 Frontier/Layer0_DeviceExchange/VulkanExchange.h — Vulkan Device Communication and Hardware Transport
//============================================================================================================================================
...
public:
    ...
    [[nodiscard]] CommandRecordSlot AcquireSlot(uint32_t SlotIndex) noexcept;
    void                    SubmitSlot(CommandRecordSlot Slot) noexcept;
    void                    SynchronizeDevice() noexcept;

    // Unified conversion operator for hardware querying
    template<typename TargetType>
    [[nodiscard]] TargetType Convert() const noexcept;

private:
    VulkanDeviceToken       m_DeviceToken;                      // [struct] physical device attributes
    uint32_t                m_ActiveSlotCount;                  // [count] command slots in ring
    bool                    m_InitializedCondition;             // [bool] initialization status
};
...
{
    return m_DeviceToken.DeviceIdentifier;
}
