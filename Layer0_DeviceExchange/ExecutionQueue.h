//============================================================================================================================================
// 📦 Frontier/Layer0_DeviceExchange/ExecutionQueue.h — Lock-Free Double-Ended Task Stealing Queue
//============================================================================================================================================
...
private:
    std::vector<TaskFunction> m_Tasks;                          // [tasks] contiguous task ring
    std::atomic<int64_t>    m_TopIndex;                         // [index] top index for task stealing
    std::atomic<int64_t>    m_BottomIndex;                      // [index] bottom index for local push/pop
};
