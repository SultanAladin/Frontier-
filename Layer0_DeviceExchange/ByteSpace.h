//============================================================================================================================================
// 📦 Frontier/Layer0_DeviceExchange/ByteSpace.h — Monotonic Transient Storage Extent with Completion-Ordered Reset
//============================================================================================================================================
...
private:
    uint8_t*                m_StorageHead;                      // [ptr] root pointer of raw storage extent
    size_t                  m_TotalCapacity;                    // [B] maximum capacity in bytes
    size_t                  m_OccupiedBytes;                    // [B] current offset in bytes
    size_t                  m_PeakOccupiedBytes;                // [B] high-water mark in bytes
};
