//============================================================================================================================================
// 📦 Frontier/DisplayPresentation/WorkspaceHost.h — Multi-Band Immediate Mode Trapezoidal Workspace Overlay and Multi-Viewport Docking
//============================================================================================================================================
...
{
public:
    WorkspaceHost() noexcept;
    ~WorkspaceHost() noexcept = default;
    ...
    [[nodiscard]] const ControlCentreHost& QueryControlCentreHost() const noexcept { return NotchControlCentreHost; }
    ControlCentreHost&     AccessControlCentreHost() noexcept { return NotchControlCentreHost; }
    [[nodiscard]] const ControlCentreHost& QueryControlPanel() const noexcept { return NotchControlCentreHost; }
    ControlCentreHost&     AccessControlPanel() noexcept { return NotchControlCentreHost; }
#endif
...
private:
    ...
    std::array<TrapezoidTabIndex, 4> TrapezoidTabs;            // [tabs] trapezoid tab geometry
...
#ifdef FRONTIER_DEVELOPMENT
    ControlCentreHost      NotchControlCentreHost;            // [panel] organic top notch control centre
#endif
};

template<>
inline WorkspaceEditMode WorkspaceHost::Convert<WorkspaceEditMode>() const noexcept
{
    return CurrentMode;
}

template<>
inline WorkspaceCategory WorkspaceHost::Convert<WorkspaceCategory>() const noexcept
{
