//============================================================================================================================================
// 📦 Frontier/Layer4_PhotometricIllumination/AtmosphereIntegrator.cpp — Henyey-Greenstein Atmosphere Implementation
//============================================================================================================================================
...
float AtmosphereIntegrator::EvaluatePhaseHenyeyGreenstein(float CosTheta, float g) noexcept
{
    float g2 = g * g;
    ...
    const Vector3& SunRadiance) const noexcept
{
    ...
    float Phase = EvaluatePhaseHenyeyGreenstein(CosTheta, Criteria.AsymmetryFactorG);
    ...
    for (uint32_t step = 0; step < Criteria.StepCount; ++step)
    {
        ...
        if (LocalDensity > 1e-4f)
        {
            ...
            // Blackbody thermal emission for hot gas (T > 600K)
            if (LocalTemp > 600.0f)
            {
