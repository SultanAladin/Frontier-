//============================================================================================================================================
// 📦 Frontier/Layer4_PhotometricIllumination/DirectIlluminationIntegrator.cpp — ReSTIR Direct Illumination Implementation
//============================================================================================================================================
...
DirectIlluminationIntegrator::DirectIlluminationIntegrator(uint32_t ExtentWidth, uint32_t ExtentHeight) noexcept
    ...
    , m_Reservoirs(ExtentWidth * ExtentHeight, IlluminationReservoir{ 0, 0.0f, 0, 0.0f })
{
}
    ...
    std::vector<Vector4>& OutRadianceField) noexcept
{
    ...
    OutRadianceField.resize(m_Width * m_Height);
    ...
    for (uint32_t y = 0; y < m_Height; ++y)
    {
        for (uint32_t x = 0; x < m_Width; ++x)
        {
            ...
            for (uint32_t s = 0; s < 8; ++s)
            {
                ...
                Reservoir.Update(CandidateIndex, Weight, RandomFloat);
            }
