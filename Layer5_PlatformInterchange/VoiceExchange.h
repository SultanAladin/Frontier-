//============================================================================================================================================
// 📦 Frontier/Layer5_PlatformInterchange/VoiceExchange.h — WebRTC 3D Positional Voice Room Routing and Audio Streaming
//============================================================================================================================================
...
public:
    ...
    void                    UpdateLocalTransform(const Vector3& Position, const Vector3& Forward) noexcept;
...
private:
    std::string             m_ActiveRoomName;                   // [name] current active voice room
    Vector3                 m_LocalPosition;                    // [m] local speaker position
    Vector3                 m_LocalForward;                     // [-] local speaker forward vector
    bool                    m_LocalMuted;                       // [bool] local microphone mute status
    std::vector<VoiceParticipant> m_Participants;               // [peers] active room participants
};
