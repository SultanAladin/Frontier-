//============================================================================================================================================
// 📦 Frontier/Layer5_PlatformInterchange/AcousticStructure.h — Acoustic Voice Records, Sound Waveforms and DSP Routing
//============================================================================================================================================
...
public:
    ...
    [[nodiscard]] size_t    QueryWaveformCount() const noexcept { return m_WaveformNames.size(); }
...
private:
    std::vector<std::string>        m_WaveformNames;            // [names] sound waveform names
    std::vector<std::vector<float>> m_PcmStorage;               // [samples] mono/stereo PCM float samples
};

template<>
inline size_t AcousticStructure::Convert<size_t>() const noexcept
{
    return m_WaveformNames.size();
}
