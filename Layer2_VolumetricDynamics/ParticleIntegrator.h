//============================================================================================================================================
// 📦 Frontier/Layer2_VolumetricDynamics/ParticleIntegrator.h — GPU Compute Particle Integration with Curl Noise Turbulence
//============================================================================================================================================
...
private:
    [[nodiscard]] Vector3   EvaluateCurlNoise(const Vector3& Position) const noexcept;

    size_t                  m_Capacity;                         // [count] maximum particle capacity
    std::vector<ParticleRecord> m_Particles;                    // [particles] contiguous particle storage
    size_t                  m_ActiveCount;                      // [count] currently alive particles
};
